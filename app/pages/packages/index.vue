  ...
  <div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div v-if="!isAdmin" class="p-8 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 text-center space-y-4 shadow-sm">
      ...
      <p class="text-sm text-slate-600 dark:text-slate-400 max-w-md mx-auto">
        {{ locale === 'th' ? 'การจัดการแพ็คเกจสินค้า/รายการตรวจ สงวนสิทธิ์เฉพาะผู้ใช้งานระดับ Admin เท่านั้น' : 'Package management is restricted to Admin users only.' }}
      </p>
    ...
    <template v-else>
      ...
      <ConfirmModal
        ...
        :description="$t('packages.confirm_delete_desc') || 'Are you sure you want to permanently delete this commercial package bundle?'"
